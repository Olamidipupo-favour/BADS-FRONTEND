...
useEffect(() => {
  ...
  return (
    ...
    <div className='add-patient-data mt-64'>
      ...
      <form>
        <input type="text" placeholder="0xaddress" className="rounded-xl m-3 h-10 px-1" onChange={(e)=>{
        setAddress(e.target.value);
      }}/>
      <input type="text" placeholder="Name" className="rounded-xl m-3 h-10 px-1" onChange={(e)=>{
        setName2(e.target.value);
      }}/>
      <input type="text" placeholder="Family History" className="rounded-xl m-3 h-10 px-1" onChange={(e)=>{
        setFamilyHistory(e.target.value);
      }}/>
      <input type="text" placeholder="Genotype" className="rounded-xl m-3 h-10 px-1" onChange={(e)=>{
        setGenotype(e.target.value);
      }}/>
      <input type="text" placeholder="Blood Group" className="rounded-xl m-3 h-10 px-1" onChange={(e)=>{
        setBloodGroup(e.target.value);
      }}/>
      <input type="text" placeholder="Allergy" className="rounded-xl m-3 h-10 px-1" onChange={(e)=>{
        setAllergy(e.target.value);
      }}/>
      <input type="text" placeholder="Medical History" className="rounded-xl m-3 h-10 px-1" onChange={(e)=>{
